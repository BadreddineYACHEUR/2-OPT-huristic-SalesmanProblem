...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        float[][] cities_distance = Load.loadTSPDistance("dantzig42.tsp");

        /*ArrayList<Integer> nearestN;
        ArrayList<Integer> result;

        double length = Length.routeLength(cities_distance);
        ...
        nearestN = Neighbour.nearest(cities_distance);
        length = Length.routeLength(nearestN, cities_distance);
        System.out.println("Nearest neighbour solution complete, distance: " + length);
        System.out.println("Validating solution...");
        Validator.validate_(nearestN);
        ...
        result = TwoOpt.alternate(nearestN, cities_distance);
        length = Length.routeLength(result, cities_distance);
        System.out.println("2-opt solution complete, distance: " + length);
        System.out.println("Validating solution...");
        Validator.validate_(result);
        time = System.currentTimeMillis() - startTime;
